#this is the hiv script the only difference between this script and the other script
...
#if you look in invtext.csv that should be the pattern - 28 lines including the line that is the same as flagtext
flagtext='32453600 PO BOX 12140 BURLINGTON, NC 27216-2140 (800) 343 - 4407 TAX ID: 13-3757370'
with open('../input/invtext.csv') as csvfile:
    ...
    for row in reader:
        if row['TextRows']==flagtext:
            print('foundone')
            for i in range(int(row['Index']), int(row['Index'])+28):
                norow.append(i)
